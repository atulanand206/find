...
func (crud TeamCrud) CreateTeams(teams []Team) (err error) {
...
func (crud TeamCrud) FindTeams(match Game) (teams []Team, err error) {
...
func (crud TeamCrud) FindTeamsMatches(match []Game) (teams []Team, err error) {
...
func (crud TeamCrud) FindTPs(teamPlayers []Subscriber) (teams []Team, err error) {
...
func (crud TeamCrud) UpdateTeam(team Team) (err error) {
